        ...
        <form className="space-y-6">
          ...
          <div>
            ...
            {learningObjectives.map((objective, index) => (
              <div
                key={index}
                className="flex items-center mb-2 border shadow p-1.5 rounded-md max-w-5xl"
              >
          ...
          <div>
            ...
            {requirements.map((requirement, index) => (
              <div
                key={index}
                className="flex items-center mb-2 border shadow p-1.5 px-3 rounded-md max-w-5xl"
              >
                <Goal className="w-6 h-6 me-2" />
                {/* <div className="w-2 h-2 bg-black rounded mr-2"></div> */}
                <div className="flex w-full justify-between items-center ">
          ...
          <div>
            ...
            <div className="flex mb-2">
              ...
              <Button
                ...
                className="ml-2 h-11 bg-white border  border-gray-300"
              >
